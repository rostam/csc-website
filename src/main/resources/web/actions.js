...
function do_actions() {
    ...
    if (action == "Load and Draw") {
        if (act_name == 'gen') load_generator(true, false, endLoaderIcon,false,false);
        else if(act_name == 'free') load_free(endLoaderIcon);
        else load_graph(act_name, true, false, endLoaderIcon,false,false);
    } else if (action == "Load Only") {
        if (act_name == 'gen') load_generator(false, false, endLoaderIcon, false,false);
        else if(act_name == 'free') load_free(endLoaderIcon);
        else load_graph(act_name, false, false, endLoaderIcon, false,false);
        ...
        if (act_name == 'gen') load_generator(true, true, endLoaderIcon,false,false);
        else if(act_name == 'free') load_free(endLoaderIcon)
        else load_graph(act_name, true, true, endLoaderIcon,false,false);
    } else if (action == "3D Force Directed") {
        if (act_name == 'gen') load_generator(true, true, endLoaderIcon, true,false);
        else if(act_name == 'free') load_free(endLoaderIcon)
        else load_graph(act_name, true, true, endLoaderIcon, true,false);
    } else if (action == "3D Force Directed D3") {
              if (act_name == 'gen') load_generator(true, true, endLoaderIcon, true,true);
              else if(act_name == 'free') load_free(endLoaderIcon)
              else load_graph(act_name, true, true, endLoaderIcon, true,true);
    }
